...
<div class="mb-7 page-intro">
    ...
    <h1 class="text-xl font-bold grad-cyan mb-0.5">Tambah Pengguna Baru</h1>
    ...
    <form action="<?= base_url('admin/user/store') ?>" method="POST">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
            <div>
                ...
                <input type="text" name="nama_lengkap" value="<?= old('nama_lengkap') ?>"
                       placeholder="Nama lengkap pengguna" class="glass-input w-full px-4 py-2.5 text-sm" required>
            </div>
            <div>
                ...
                <input type="text" name="username" value="<?= old('username') ?>"
                       placeholder="username unik" class="glass-input w-full px-4 py-2.5 text-sm" required>
            </div>
        </div>
        ...
        <div class="mb-5">
            ...
            <input type="email" name="email" value="<?= old('email') ?>"
                   placeholder="email@contoh.com" class="glass-input w-full px-4 py-2.5 text-sm" required>
        </div>

        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
            <div>
                <label class="block text-[10px] font-bold uppercase tracking-widest mb-2" style="color:rgba(245,158,11,.75);">Password</label>
