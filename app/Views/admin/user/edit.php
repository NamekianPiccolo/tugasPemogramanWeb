...
<div class="mb-5 page-intro flex items-center justify-between">
    <div>
        ...
        <h1 class="text-xl font-bold grad-violet mb-0.5">Edit Pengguna</h1>
    ...
    <div class="grid gap-5" style="grid-template-columns:3fr 2fr;align-items:start">
        ...
        <div class="glass-card static-card" style="padding:28px 32px;border-radius:14px">
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div class="fl-group">
                    <input type="text" name="nama_lengkap" id="nama_lengkap" value="<?= old('nama_lengkap', $user['nama_lengkap']) ?>" placeholder="Nama Lengkap" class="fl-input" required>
                ...
                <div class="fl-group">
                    <input type="text" name="username" id="username" value="<?= old('username', $user['username']) ?>" placeholder="Username" class="fl-input" required>
            ...
            <div class="fl-group mb-4">
                <input type="email" name="email" id="email" value="<?= old('email', $user['email']) ?>" placeholder="Email" class="fl-input" required>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="fl-group pwd-wrap">
                    <input type="password" name="password" id="password" placeholder="Password Baru (Kosongkan jika tidak diubah)" class="fl-input" style="padding-right:44px!important">
                    <label for="password" class="fl-label">Password Baru</label>
        ...
        <div class="flex flex-col gap-4">
            <div class="glass-card static-card p-5" style="border-radius:14px">
                ...
                <div class="space-y-3 text-xs" style="color:var(--muted);line-height:1.7">
                    ...
                    <p>🔒 Kosongkan password jika tidak ingin mengubah password lama pengguna.</p>
                </div>
            </div>
