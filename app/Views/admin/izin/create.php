...
<form action="<?= base_url('karyawan/izin/store') ?>" method="POST">
    ...
    <div class="grid gap-5" style="grid-template-columns:3fr 2fr;align-items:start">
        ...
        <div class="glass-card static-card" style="padding:28px 32px;border-radius:14px">
            <div class="sec-sep"><div class="sec-sep-line"></div><span>Detail Pengajuan</span></div>
            ...
            <div class="fl-group is-textarea">
                <textarea name="pesan" id="pesan" rows="5" placeholder="Alasan Pengajuan" class="fl-input"></textarea>
                <label for="pesan" class="fl-label">Alasan / Pesan Pengajuan</label>
                <svg class="fl-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z"/></svg>
            </div>
        </div>
        ...
        <div class="flex flex-col gap-4">
            <div class="glass-card static-card p-5" style="border-radius:14px">
                <div class="sec-sep"><div class="sec-sep-line" style="background:var(--primary)"></div><span>Info Pengajuan</span></div>
