    ...
    <div class="grid gap-5" style="grid-template-columns:3fr 2fr;align-items:start">
        ...
        <div class="glass-card static-card" style="padding:28px 32px;border-radius:14px">
            ...
            <div class="fl-group">
                ...
                <label for="nama_unit" class="fl-label">Nama Unit / Divisi <span class="req">*</span></label>
        ...
        <div class="flex flex-col gap-4">
            <div class="glass-card static-card p-5" style="border-radius:14px">
                ...
                <div class="space-y-3 text-xs" style="color:var(--muted);line-height:1.7">
                    <p>🏢 Gunakan nama resmi unit atau divisi sesuai struktur organisasi, misalnya "Departemen Keuangan" atau "Divisi IT".</p>
                    <p>📂 Unit kerja digunakan untuk mengelompokkan kepemilikan dokumen per divisi.</p>
                </div>
            </div>
