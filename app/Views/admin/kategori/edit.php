...
<div class="mb-5 page-intro flex items-center justify-between">
    <div>
        ...
        <h1 class="text-xl font-bold grad-violet mb-0.5">Edit Kategori</h1>
        ...
        <div class="glass-card static-card" style="padding:28px 32px;border-radius:14px">
            ...
            <div class="fl-group">
                <input type="text" name="nama_kategori" id="nama_kategori"
                       ...
                       placeholder="Nama Kategori" class="fl-input" required>
                <label for="nama_kategori" class="fl-label">Nama Kategori <span style="color:var(--secondary)">*</span></label>
        ...
        <div class="flex flex-col gap-4">
            <div class="glass-card static-card p-5" style="border-radius:14px">
                ...
                <div class="space-y-2 text-xs" style="color:var(--muted);line-height:1.7">
                    <p>🏷️ Ubah nama kategori jika diperlukan. Perubahan akan berlaku untuk semua dokumen dalam kategori ini.</p>
                </div>
            </div>
